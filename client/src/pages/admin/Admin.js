        ...
        <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
          ...
          <div className="flex flex-col space-y-4 2xl:container  m-2 ">
            <div className="flex flex-col lg:flex-row gap-3">
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-purple-300 to-purple-800 py-8 items-center justify-center flex text-white ">
               6 Invoices Sent
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-indigo-300 to-indigo-800 py-8 items-center justify-center flex text-white ">
                17  Pending Orders
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-yellow-300 to-yellow-800 py-8 items-center justify-center flex text-white ">
               6  Pending Deliveries
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-orange-300 to-orange-800 py-8 items-center justify-center flex text-white ">
                Acc Balance Ksh 78,976.00
              </div>
            </div>
          </div>
          ...
          <div className="px-6 pt-6 2xl:container">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="md:col-span-2 lg:col-span-1">
                <div className="h-full py-8 px-6 space-y-6 border border-green-400 bg-white">
                  <svg
                  ...
                  <div>
                    ...
                    <span className="block text-center text-gray-500">
                      Compared to last week KSh 13,988.00
                    </span>
                  </div>
                  <table className="w-full text-gray-600">
                    <tbody>
                      <tr>
                        <td className="py-2">Solar Pannels</td>
                      ...
                      <tr>
                        <td className="py-2">Batteries</td>
              ...
              <div>
                <div className="h-full py-6 px-6 border border-green-400 bg-white">
                  <h5 className="text-xl text-gray-700">Sales</h5>
                  <div className="my-8">
              ...
              <div>
                <div className="lg:h-full py-8 px-6 text-gray-600 border border-green-400 bg-white">
                <h5 className="text-xl text-gray-900 text-center mb-2">
                      Refunds
                    </h5>
                  <svg
