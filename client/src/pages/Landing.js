    ...
    <div>
      <Navbar />
        ...
        <div class="flex flex-col md:flex-row pt-28">
          <div class="md:w-1/2 md:pr-10 md:pl-10 pt-10">
            <h1 class="text-2xl font-bold leading-tight pt-4">
              Welcome to the <span class="text-green-500">Sunrays Solar ltd</span>{" "}
              <span class="text-green-500">Starter</span>
            </h1>

            <p class="text-left mt-4 font-medium">
            ...
            <div class="flex flex-row justify-center  w-64 m-10  ">
              <Link to ="/login" className="m-4 px-8 py-2 bg-green-500 rounded-full border-2 border-green-400 text-white ">
                Admin
              </Link>
              <Link to="/" className="m-4 px-8 py-2 border-2 border-green-500 rounded-full">
                User
              </Link>
            </div>
          </div>

          <div class="md:w-1/2 md:pl-10 md:pr-10 mt-4">
            <img src="./AdobeStock_336398697.jpeg" alt="" />
          </div>
        </div>
      </section>
      ...
      <section class="pt-20 2xl:pt-40 pb-40 2xl:pb-80 overflow-hidden">
        <div class="container px-4 mx-auto">
          <div class="max-w-xl mx-auto mb-16 lg:mb-28 text-center">
            <span class="text-lg font-bold text-green-500">How it works</span>
            <h2 class="mt-6 mb-12 text-6xl font-bold font-heading">
              Negotiate and close without problems
            </h2>
              ...
              <div class="relative lg:max-w-md lg:ml-auto z-10">
                ...
                <div class="absolute bottom-0 left-0 w-full px-12">
                  <div class="flex pt-10 pb-16 w-full border-t border-gray-200">
                    ...
                    <div>
                      <p class="mb-1 text-lg font-bold text-green-500">
                        Matt
                      </p>
              ...
              <div class="max-w-lg">
                <ul>
                  <li class="flex pb-10 mb-8 border-b border-gray-50">
                    <div class="mr-8">
                      <span class="flex justify-center items-center w-14 h-14 bg-green-50 text-lg font-bold rounded-full">
                        1
                      </span>
                    </div>
                    <div class="max-w-xs">
                ...
                <div class="mt-10 text-right">
                  <a
                    class="inline-block font-bold text-green-500 hover:text-green-400"
                    href="#"
                  >
      ...
      <div className="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                ...
                <p className="text-green-500 mt-4 font-bold text-4xl">
                  Sunrays.
                </p>

                    <p className="text-sm leading-none text-gray-800 mt-4">Copyright © 2022 Abi</p>
