        ...
        <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
          ...
          <div className="flex flex-col space-y-4 2xl:container  m-2 ">
            <div className="flex flex-col lg:flex-row gap-3">
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-purple-300 to-purple-800 py-8 items-center justify-center flex text-white rounded-xl">
                Total Invoices
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-indigo-300 to-indigo-800 py-8 items-center justify-center flex text-white rounded-xl">
                Orders Pending
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-yellow-300 to-yellow-800 py-8 items-center justify-center flex text-white rounded-xl">
                Deliveries
              </div>
              <div className="w-full lg:w-1/4 bg-gradient-to-br from-orange-300 to-orange-800 py-8 items-center justify-center flex text-white rounded-xl">
                Account Balance
              </div>
            </div>
          </div>
